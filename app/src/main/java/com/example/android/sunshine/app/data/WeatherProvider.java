...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(authority, WeatherContract.PATH_WEATHER.concat("/*"), WEATHER_WITH_LOCATION);
        uriMatcher.addURI(authority, WeatherContract.PATH_WEATHER.concat("/*/#"), WEATHER_WITH_LOCATION_AND_DATE);
