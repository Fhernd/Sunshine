...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Uri uriLocation = WeatherContract.LocationEntry.CONTENT_URI;
        long locationId;

        // Check if the location with the passed city name exists:
        Cursor locationCursor = mContext.getContentResolver().query(uriLocation,
        ...
        if (locationCursor.moveToFirst()){
            ...
            Uri uri = mContext.getContentResolver().insert(uriLocation, values);
